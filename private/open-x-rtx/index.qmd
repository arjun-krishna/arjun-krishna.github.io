...
- In-distribution: 
    ...
    - Would it be beneficial to train with data from other robots? 
        - If so, would it's impact on a task be different based on the initial _quantity_ of data available?
- Out-of-distribution:
...
Evaluates out-of-distribution performance of RT-2-X on the Google Robot.
