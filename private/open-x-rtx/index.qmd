...
<span style="font-size: 60%">* _trained only on a fraction of the full dataset_</span>
:::
...
- Not open-sourced; but recent open-source models like [LLaVA-v1.5-13B](https://llava-vl.github.io/) make this pipeline potentially replicable.
:::
...
::: aside 
\* Does not report number of evaluations performed to obtain success rates.
:::
...
## <span style="font-size:80%">Results: RT-2-X ablations</span> {.smaller}
