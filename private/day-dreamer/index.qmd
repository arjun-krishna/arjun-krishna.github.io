...
::: {width="100%" style="font-size: 80%"}
- Dreamer achieves performance of 3.5 objects / minute in 10hrs
- Sometimes used the string to pull the object out of a corner.
:::
...
- Dreamer is capable of recovering original performance 
