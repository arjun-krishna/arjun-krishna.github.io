var w = window.innerWidth /1.7,
    ...
    var svg = d3.select("#graph_1").attr({
        width: w,
        height: h
      });
    ...
    d3.csv("/assets/SVD_compress/vis/compress.csv", function(d) {
      ...
      function handleMouseOver(d, i) {  // Add interactivity
            ...
            document.getElementById('recn_1').src = '/assets/SVD_compress/vis/img/svd_R_K_'+d.x+'.png'
            document.getElementById('diff_1').src = '/assets/SVD_compress/vis/img/svd_D_K_'+d.x+'.png'
      ...
      function handleMouseOut(d, i) {
            ...
            document.getElementById('recn_1').src = '/assets/SVD_compress/vis/none.png'
            document.getElementById('diff_1').src = '/assets/SVD_compress/vis/none.png'
          }
